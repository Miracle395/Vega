...
window.executeMarginDeposit = async function({ amount }) {
  ...
  typeArguments: [MARGIN_EXEC_CFG.SUI_TYPE, MARGIN_EXEC_CFG.DBUSDC_TYPE, MARGIN_EXEC_CFG.DBUSDC_TYPE], // was missing 3rd arg
  arguments: [
    tx.object(managerId),
    tx.object(MARGIN_EXEC_CFG.MARGIN_REGISTRY),
    tx.object(MARGIN_EXEC_CFG.SUI_PRICE_INFO),
    tx.object(MARGIN_EXEC_CFG.DBUSDC_PRICE_INFO),
    depositCoin,
    tx.object(MARGIN_EXEC_CFG.CLOCK),
  ],
});

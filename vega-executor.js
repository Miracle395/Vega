...
async function _loadDeepBookModules() {
  ...
  _dbModulesPromise = (async () => {
    const [dbMod, suiMod, { Transaction }] = await Promise.all([
      import('https://esm.sh/@mysten/deepbook-v3'),
      import('https://esm.sh/@mysten/sui@2.17.0'),
      import('https://esm.sh/@mysten/sui@2.17.0/transactions'),
    ]);
    const DeepBookClient = dbMod.DeepBookClient;
    const SuiClient = suiMod.SuiClient;
...
// SuiClient already loaded from SDK loader above
